...
<#--<link rel="stylesheet" type="text/css" href="<@s.url '/static/css/modules/User/simDiagnostic.css'/>"/>
<script type="text/javascript" src="<@s.url '/static/js/modules/User/simDiagnostic.js'/>"></script>-->
<!-- END PAGE LEVEL STYLES -->
<link rel="stylesheet" href="${base}/src/main/webapp/static/css/modules/test/simDiagnostic.css"/>
<script type="text/javascript" src="${base}/src/main/webapp/static/js/modules/test/simDiagnostic.js"></script>
