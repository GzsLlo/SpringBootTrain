...
package com.coocle.springboot.conf.dataSource.info;
...
@MapperScan(basePackages = {"com.coocle.springboot.mapper.info"}, sqlSessionTemplateRef = "infoSqlSessionTemplate")
